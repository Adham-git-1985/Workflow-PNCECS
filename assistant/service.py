...
_HOW_TO_GUIDES = (
    ...
    },
    {
        ...
        "reply": (
            ...
            "3) قائمة تحويل قابلة للبحث، ومستعرض منظم للهيكل يعرض الجهات والمستخدمين حسب المستوى، ولوحة عمل إجرائية للمراسلات وفلاتر قابلة للنقر في صفحة المسارات التي تتابعها.\n"
