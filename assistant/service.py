...
_HOW_TO_GUIDES = (
    ...
    },
    {
        ...
        "reply": (
            ...
            "2) اختر واردًا أو صادرًا وأدخل الجهة والموضوع والتاريخ؛ ينشئ النظام الرقم الرسمي تلقائيًا من تسلسل مركزي لجميع المستخدمين بصيغة واضحة مثل «وارد-2026-000001» أو «صادر-2026-000001».\n"
    ...
    },
    {
        ...
        "reply": (
            ...
            "4) قائمة تحويل قابلة للبحث، ومستعرض منظم للهيكل يعرض الجهات والمستخدمين حسب المستوى، ولوحة عمل إجرائية للمراسلات وفلاتر قابلة للنقر في صفحة المسارات التي تتابعها.\n"
