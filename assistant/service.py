...
_HOW_TO_GUIDES = (
    ...
    },
    {
        ...
        "reply": (
            ...
            "4) راجع الإجراء المقترح. عند التحويل أو الإرسال للاعتماد استخدم قائمة «التحويل إلى» القابلة للبحث؛ تعرض الأسماء الطويلة بوضوح داخل القائمة، ويمكنك أيضًا الاختيار من الهيكل التنظيمي.\n"
    ...
    },
    {
        ...
        "reply": (
            ...
            "2) فتح المهمة مباشرةً عند منطقة الإجراء والملاحظة والمرفقات مع تمييزها بصريًا.\n"
            "3) قائمة تحويل قابلة للبحث تعرض أسماء الموظفين والجهات الطويلة بوضوح، ولوحة عمل إجرائية للمراسلات وفلاتر قابلة للنقر في صفحة المسارات التي تتابعها.\n"
            "4) تطوير محاضر الاجتماعات وعناوينها وأسماء ملفاتها ومرفقاتها واتجاه النص.\n"
            "5) تعريب مسميات الحالات والأدوار والصلاحيات الظاهرة للمستخدم."
        ),
    },
    {
