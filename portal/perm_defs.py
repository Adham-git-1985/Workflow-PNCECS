...
PERMS: Dict[str, List[PermDef]] = {
    ...
    "مسار العمل ولوحات المتابعة": [
        ...
        PermDef(
            ...
            "إعادة فتح المسار",
            "السماح بإعادة فتح مسار الطلب وإرجاعه إلى خطوة حالية أو سابقة لاستكمال المعالجة.",
            module="WORKFLOW",
        ),
        PermDef(
            "WORKFLOW_SECRETARY_ENDORSEMENTS",
            "تأشيرات الأمين العام السريعة",
            "إظهار واستخدام التأشيرات الجاهزة في مسار، مثل: «لاتخاذ اللازم»، من دون كتابة تعليق يدوي. إنشاء التأشيرات وإدارتها محصوران بالمدير والسوبر أدمن.",
            module="WORKFLOW",
        ),
        PermDef(
            "WORKFLOW_EMPLOYEE_ENDORSEMENTS",
            "تأشيرات الموظفين",
            "تُمنح لموظف محدد ليستخدم قائمة تأشيرات الموظفين المستقلة ويضيفها كتَعليق في مسار. يدير المدير والسوبر أدمن هذه القائمة من أي مسار، وتظهر لجميع الموظفين المخوّلين فقط؛ ولا تشمل تأشيرات الأمين العام.",
            module="WORKFLOW",
            user_only=True,
        ),
    ...
    "متابعات الإنجاز": [
        PermDef("FOLLOWUPS_READ", "عرض متابعاتي", "عرض تقارير الإنجاز الخاصة بالمستخدم، والتقارير المعتمدة للأمين العام حسب الدور.", module="FOLLOWUPS"),
    ...
    "الحركة والنقل": [
        ...
        PermDef("TRANSPORT_REQUEST", "طلب حركة", "إنشاء طلب حركة شخصي من منطقة إلى منطقة.", module="TRANSPORT_REQUEST"),
        PermDef("TRANSPORT_MANAGER_APPROVE", "مسؤول الحركة والنقل", "اعتماد طلبات الحركة وتعيين السيارة والسائق.", module="TRANSPORT_APPROVE"),
        PermDef("TRANSPORT_DIRECTOR_APPROVE", "مدير النقل البديل", "اعتماد طلبات الحركة وتعيين السائق عند غياب مسؤول الحركة والنقل.", module="TRANSPORT_APPROVE"),
        PermDef("TRANSPORT_ADMIN_APPROVE", "مدير الشؤون الإدارية", "الاعتماد النهائي لطلبات الحركة بعد تعيين السائق.", module="TRANSPORT_APPROVE"),
