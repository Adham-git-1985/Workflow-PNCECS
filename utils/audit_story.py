...
_ACTION_TEMPLATES = {
    ...
    "WORKFLOW_COMMENT": "أضاف {actor} تعليقًا إلى المعاملة.",
    ...
    "WORKFLOW_MENTION_TASK_COMPLETED": "أكمل {actor} متابعة الإشارة إليه دون تغيير مسار المعاملة.",
    "WORKFLOW_ENDORSEMENT_CREATED": "أضاف {actor} تأشيرة سريعة لمسار العمل.",
    "WORKFLOW_ENDORSEMENT_RESTORED": "استعاد {actor} تأشيرة سريعة لمسار العمل.",
    "WORKFLOW_ENDORSEMENT_REMOVED": "أزال {actor} تأشيرة سريعة لمسار العمل.",
    ...
    "PORTAL_CIRCULAR_CREATE": "أصدر {actor} التعميم الإداري.",
    "PORTAL_CIRCULAR_STATUS_UPDATE": "حدّث {actor} حالة التعميم الإداري.",
    "PORTAL_CIRCULAR_EMAIL_SEND": "أرسل {actor} نسخة البريد الإلكتروني للتعميم.",
    "PORTAL_CIRCULAR_WHATSAPP_SEND": "أرسل {actor} نسخة واتساب للتعميم.",
    "PORTAL_CIRCULAR_DELETE": "حذف {actor} التعميم الإداري.",
